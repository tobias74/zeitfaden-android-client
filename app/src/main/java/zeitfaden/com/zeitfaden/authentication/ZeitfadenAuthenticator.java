...
import zeitfaden.com.zeitfaden.activities.AuthenticatorActivity;

import static android.accounts.AccountManager.KEY_BOOLEAN_RESULT;

import static zeitfaden.com.zeitfaden.authentication.AccountGeneral.*;

/**
 * Created by tobias on 15.08.15.
 */
public class ZeitfadenAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "UdinicAuthenticator";
    private final Context mContext;

    public ZeitfadenAuthenticator(Context context) {
        super(context);
